...
(function(t) {
    ...
    De.moment = function() {
        ...
        return this._fullCalendar && arguments[0] ? Z(this, arguments[0]) : this._ambigTime ? B(this, "DD-MM-YYYY") : this._ambigZone ? B(this, "DD-MM-YYYY[T]HH:mm:ss") : Ge.format.apply(this, arguments)
    }, _e.toISOString = function() {
        return this._ambigTime ? B(this, "DD-MM-YYYY") : this._ambigZone ? B(this, "DD-MM-YYYY[T]HH:mm:ss") : Ge.toISOString.apply(this, arguments)
    ...
    var Oe = K.extend({
        ...
        Xe = De.Grid = je.extend({
            ...
            bgCellHtml: function(t) {
                ...
                return i.unshift("fc-day", e.widgetContentClass), '<td class="' + i.join(" ") + '"' + ' data-date="' + n.format("DD-MM-YYYY") + '"' + "></td>"
            },
