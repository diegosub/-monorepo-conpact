            ...
            l = function() {
                ...
                return s.prototype.init = function() {
                    ...
                    return this.each(function() {
                        var e = n(this),
                            o = e.data("metisMenu"),
                            r = n.extend({}, a, e.data(), "object" === (void 0 === i ? "undefined" : t(i)) && i);
...
! function(n) {
    ...
    n(document).ready(function() {
        ...
        i.length && i.nanoScroller({
            preventPageScrolling: !0
        }), n.niftyNav("bind"), n.niftyAside("bind"), n(document).on("click", "#nav-searchbox", function(a) {
    ...
    n(document).one("nifty.ready", function() {
        ...
        if (a.length && !t) {
            var i = !1,
                o = 250,
                s = function() {
                    e.scrollTop() > o && !i ? (a.addClass("in").stop(!0, !0).css({
                        animation: "none"
                    }).show(0).css({
                        animation: "jellyIn .8s"
                    }), i = !0) : e.scrollTop() < o && i && (a.removeClass("in"), i = !1)
                };
            s(), e.scroll(s), a.on("click", function(a) {
                a.preventDefault(), n("body, html").animate({
                    scrollTop: 0
                }, 500)
            })
        } else a = null, e = null;
    ...
    n.niftyNoty = function(r) {
        ...
        (function() {
            if (f.onShow(), "page" === f.container) a || (a = n('<div id="page-alert"></div>'), i && i.length || (i = n("#content-container")), i.prepend(a)), e = a, f.focus && g(0);
            else if ("floating" === f.container) o[f.floating.position] || (o[f.floating.position] = n('<div id="floating-' + f.floating.position + '" class="floating-container"></div>'), t && i.length || (t = n("#container")), t.append(o[f.floating.position])), e = o[f.floating.position], f.floating.animationIn && u.addClass("in animated " + f.floating.animationIn), f.focus = !1;
            else {
                var l = n(f.container),
            ...
            var i = n.extend({}, a, t),
                ...
                d = function(n) {
                    l.removeClass("active"), n.addClass("active"), o.html(n.html()), r = n.find(".lang-id").text(), c = n.find(".lang-name").text(), e.trigger("onChange", [{
                        id: r,
                        name: c
                    }]), "function" == typeof i.onChange && i.onChange.call(this, {
                        id: r,
                        name: c
                    })
                };
    ...
    var a = null,
        ...
        m = function() {
            ...
            o.metisMenu({
                toggle: !0
            }).metisMenu("dispose").find(".collapse").filter(function() {
                ...
                n("#mainnav-menu-wrap > .nano").on("update", function() {
                    ...
                    u.find(".nano-content").children().css("height", ""), t > l ? (f.length && !f.is(":visible") && (s = Math.round(0 - .5 * s)), t -= 5, u.css({
                        ...
                        preventPageScrolling: !0
                    }), g(u.find(".nano"))) : (!e.hasClass("navbar-fixed") && i.hasClass("affix-top") && (l -= 50), c > l ? ((e.hasClass("navbar-fixed") || i.hasClass("affix-top")) && (l -= s + 5), l -= 5, u.css({
                        top: s + "px",
                        bottom: "",
                        height: l
                    }).children().addClass("nano").css({
                        ...
                        preventPageScrolling: !0
                    }), g(u.find(".nano"))) : (f.length && !f.is(":visible") && (s = Math.round(0 - .5 * s)), u.css({
                        top: s + "px",
                        bottom: "",
                        height: "auto"
        ...
        y = {
            ...
            fixedPosition: function() {
                e.addClass("mainnav-fixed"), l.nanoScroller({
                    preventPageScrolling: !0
                }), h()
            },
            staticPosition: function() {
                e.removeClass("mainnav-fixed"), l.nanoScroller({
                    preventPageScrolling: !1
                }), h()
            },
            update: C,
            ...
            bind: function() {
                ...
                try {
                    l = n("#mainnav-menu-wrap > .nano"), l.length && l.nanoScroller({
    ...
    var a, e, t, i, o, s, l = function(n) {
            clearInterval(s), s = setInterval(function() {
                ...
                }) : n[0] == e[0] && o.nanoScroller({
                    preventPageScrolling: !!t.hasClass("aside-fixed")
                }), clearInterval(s), s = null
            }, 500)
        },
        r = function() {
            t = n("#container"), a = n("#mainnav-container"), e = n("#aside-container"), i = n("#mainnav-menu-wrap > .nano"), o = n("#aside > .nano"), a.length && a.niftyAffix({
                className: "mainnav-fixed"
            }), e.length && e.niftyAffix({
    ...
    n.fn.niftyAffix = function(a) {
        return this.each(function() {
            var e, i = n(this);
            "object" != typeof a && a ? "update" == a ? (i.data("nifty.af.class") || r(), e = i.data("nifty.af.class"), l(i)) : "bind" == a && r() : (e = a.className, i.data("nifty.af.class", a.className)), t.hasClass(e) && !t.hasClass("navbar-fixed") ? i.affix({
                offset: {
